...
public static class EffectLibrary
{
    public static readonly IReadOnlyList<LedEffect> Default = new LedEffect[]
    {
        ...
        new(5, "rain", HasSpeed: true, HasBrightness: true, HasColor: true),
        new(6, "color_shift", HasSpeed: true, HasBrightness: true, HasColor: true),
        new(7, "ripple", HasSpeed: true, HasBrightness: true, HasColor: true),
        new(8, "starlight", HasSpeed: true, HasBrightness: true, HasColor: true),
        ...
        new(12, "reactive", HasSpeed: true, HasBrightness: true, HasColor: true),
